    ...
    <section>
      ...
      <div className="mx-5 mt-10">
        <div className="flex ">
          ...
          <button class="flex flex-row items-center justify-center min-w-[130px] px-4 rounded-full font-medium border disabled:cursor-not-allowed disabled:opacity-50 transition ease-in-out duration-150 text-base bg-[#5d956dbe] text-white  tracking-wide border-transparent py-1.5 h-[38px]">
            See All
          </button>
        </div>

        <div class=" mx-auto mt-24 flex flex-col gap-y-5">
          <div class=" bg-[#5d956d46] gap-y-2 shadow border rounded-xl overflow-hidden items-center justify-between px-10 py-5">
