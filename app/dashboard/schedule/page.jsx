  ...
  return (
    <section>
      ...
      <div className="mx-5 mt-10">
        ...
        {value?.day && (
          <div className="grid grid-cols-4 justify-center items-center gap-2 mt-3">
            <div className="flex flex-col items-center justify-center max-w-[300px] bg-white overflow-hidden shadow rounded-lg border py-5 hover:shadow-sm hover:bg-[#5d956d36] duration-500">
